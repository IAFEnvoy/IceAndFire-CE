...
public class GhostSwordEntityRenderer extends EntityRenderer<GhostSwordEntity> {
    ...
    @Override
    public void render(GhostSwordEntity entityIn, float entityYaw, float partialTicks, PoseStack matrixStackIn, @NotNull MultiBufferSource bufferIn, int packedLightIn) {
