...
public class DreadScuttlerModel extends DragonBaseModel<DreadScuttlerEntity> {
    ...
    @Override
    public void setupAnim(@NotNull DreadScuttlerEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
