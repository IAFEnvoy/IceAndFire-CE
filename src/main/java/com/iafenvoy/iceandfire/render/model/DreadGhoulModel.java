    ...
    public void setupAnim(DreadGhoulEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        ...
        if (entity.getAnimation() == DreadGhoulEntity.ANIMATION_SPAWN) {
            if (entity.getAnimationTick() < 30) {
                this.swing(this.armRight, 0.5F, 0.5F, false, 2, -0.7F, entity.tickCount, 1);
                this.swing(this.armLeft, 0.5F, 0.5F, true, 2, -0.7F, entity.tickCount, 1);
                this.flap(this.armRight, 0.5F, 0.5F, true, 1, 0, entity.tickCount, 1);
                this.flap(this.armLeft, 0.5F, 0.5F, true, 1, 0, entity.tickCount, 1);
            }
        }
        this.flap(this.armLeft, speed_idle, 0.15F, false, 2, -0.1F, entity.tickCount, 1);
        this.flap(this.armRight, speed_idle, 0.15F, true, 2, -0.1F, entity.tickCount, 1);
        this.walk(this.head, speed_idle, 0.1F, true, 1, -0.05F, entity.tickCount, 1);
