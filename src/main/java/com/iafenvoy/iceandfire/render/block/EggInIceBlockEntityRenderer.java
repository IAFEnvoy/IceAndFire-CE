...
public class EggInIceBlockEntityRenderer<T extends EggInIceBlockEntity> implements BlockEntityRenderer<T, EggInIceBlockEntityRenderer.State> {
    ...
    @Override
    public void extractRenderState(T egg, State state, float partialTicks, net.minecraft.world.phys.@NonNull @NonNull Vec3 cameraPosition, net.minecraft.client.renderer.feature.ModelFeatureRenderer.CrumblingOverlay breakProgress) {
