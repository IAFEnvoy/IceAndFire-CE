...
public final class IafProcessors {
    ...
    public static final DeferredHolder<StructureProcessorType<?>, StructureProcessorType<DreadPortalProcessor>> DREAD_PORTAL_PROCESSOR = registerProcessor("dread_portal_processor", () -> () -> DreadPortalProcessor.CODEC);
