...
public final class IafTrades {
    ...
    public static final DeferredHolder<VillagerProfession, VillagerProfession> SCRIBE_PROFESSION = PROFESSION_REGISTRY.register(SCRIBE, () -> new VillagerProfession(SCRIBE, e -> e.is(SCRIBE_POI.getKey()), e -> e.is(SCRIBE_POI.getKey()), ImmutableSet.of(), ImmutableSet.of(), SoundEvents.VILLAGER_WORK_LIBRARIAN));
