...
import com.iafenvoy.iceandfire.entity.NetherDragonEntity;
...
public class NetherDragonTabulaModelAnimator extends DragonTabulaModelAnimator<NetherDragonEntity> {
    public NetherDragonTabulaModelAnimator() {
