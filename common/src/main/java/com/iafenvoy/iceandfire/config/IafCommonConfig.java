...
public class IafCommonConfig extends AutoInitConfigContainer {
    ...
    public static class DragonConfig extends AutoInitConfigCategoryBase {
        ...
        public final IntegerEntry maxPathingNodes = IntegerEntry.builder("config.iceandfire.dragon.maxPathingNodes", 5000).min(0).json("maxPathingNodes").build();
        ...
        public final BooleanEntry neutralToPlayer = BooleanEntry.builder("config.iceandfire.dragon.neutralToPlayer", false).json("neutralToPlayer").build();
        public final BooleanEntry enableBrushDragonScales = BooleanEntry.builder("config.iceandfire.dragon.enableBrushDragonScales", true).json("enableBrushDragonScales").build();
        public final IntegerEntry maxBrushScalesDropPerTime = IntegerEntry.builder("config.iceandfire.dragon.maxBrushScalesDropPerTime", 2).min(1).json("maxBrushScalesDropPerTime").build();
        public final DoubleEntry brushTimesMul = DoubleEntry.builder("config.iceandfire.dragon.brushTimesMul", 1).min(0).json("brushTimesMul").build();
