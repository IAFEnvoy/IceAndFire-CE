...
public class MausoleumStructure extends IafJigsawStructure implements DangerousGeneration {
    ...
    public MausoleumStructure(Config config, RegistryEntry<StructurePool> startPool, Optional<Identifier> startJigsawName, int size, HeightProvider startHeight, Optional<Heightmap.Type> projectStartToHeightmap, int maxDistanceFromCenter, StructureGenerationConfig generationConfig) {
