...
public final class IafItems {
    ...
    public static final RegistrySupplier<Item> DRAGONSTEEL_FIRE_SWORD = register("dragonsteel_fire_sword", () -> new ItemModSword(createMaterialWithRepairItem(DRAGONSTEEL_FIRE_INGOT.get())));
    public static final RegistrySupplier<Item> DRAGONSTEEL_FIRE_PICKAXE = register("dragonsteel_fire_pickaxe", () -> new ItemModPickaxe(createMaterialWithRepairItem(DRAGONSTEEL_FIRE_INGOT.get())));
    public static final RegistrySupplier<Item> DRAGONSTEEL_FIRE_AXE = register("dragonsteel_fire_axe", () -> new ItemModAxe(createMaterialWithRepairItem(DRAGONSTEEL_FIRE_INGOT.get())));
    public static final RegistrySupplier<Item> DRAGONSTEEL_FIRE_SHOVEL = register("dragonsteel_fire_shovel", () -> new ItemModShovel(createMaterialWithRepairItem(DRAGONSTEEL_FIRE_INGOT.get())));
    public static final RegistrySupplier<Item> DRAGONSTEEL_FIRE_HOE = register("dragonsteel_fire_hoe", () -> new ItemModHoe(createMaterialWithRepairItem(DRAGONSTEEL_FIRE_INGOT.get())));
    ...
    public static final RegistrySupplier<Item> DRAGONSTEEL_ICE_SWORD = register("dragonsteel_ice_sword", () -> new ItemModSword(createMaterialWithRepairItem(DRAGONSTEEL_ICE_INGOT.get())));
    public static final RegistrySupplier<Item> DRAGONSTEEL_ICE_PICKAXE = register("dragonsteel_ice_pickaxe", () -> new ItemModPickaxe(createMaterialWithRepairItem(DRAGONSTEEL_ICE_INGOT.get())));
    public static final RegistrySupplier<Item> DRAGONSTEEL_ICE_AXE = register("dragonsteel_ice_axe", () -> new ItemModAxe(createMaterialWithRepairItem(DRAGONSTEEL_ICE_INGOT.get())));
    public static final RegistrySupplier<Item> DRAGONSTEEL_ICE_SHOVEL = register("dragonsteel_ice_shovel", () -> new ItemModShovel(createMaterialWithRepairItem(DRAGONSTEEL_ICE_INGOT.get())));
    public static final RegistrySupplier<Item> DRAGONSTEEL_ICE_HOE = register("dragonsteel_ice_hoe", () -> new ItemModHoe(createMaterialWithRepairItem(DRAGONSTEEL_ICE_INGOT.get())));
    ...
    public static final RegistrySupplier<Item> DRAGONSTEEL_LIGHTNING_SWORD = register("dragonsteel_lightning_sword", () -> new ItemModSword(createMaterialWithRepairItem(DRAGONSTEEL_LIGHTNING_INGOT.get())));
    public static final RegistrySupplier<Item> DRAGONSTEEL_LIGHTNING_PICKAXE = register("dragonsteel_lightning_pickaxe", () -> new ItemModPickaxe(createMaterialWithRepairItem(DRAGONSTEEL_LIGHTNING_INGOT.get())));
    public static final RegistrySupplier<Item> DRAGONSTEEL_LIGHTNING_AXE = register("dragonsteel_lightning_axe", () -> new ItemModAxe(createMaterialWithRepairItem(DRAGONSTEEL_LIGHTNING_INGOT.get())));
    public static final RegistrySupplier<Item> DRAGONSTEEL_LIGHTNING_SHOVEL = register("dragonsteel_lightning_shovel", () -> new ItemModShovel(createMaterialWithRepairItem(DRAGONSTEEL_LIGHTNING_INGOT.get())));
    public static final RegistrySupplier<Item> DRAGONSTEEL_LIGHTNING_HOE = register("dragonsteel_lightning_hoe", () -> new ItemModHoe(createMaterialWithRepairItem(DRAGONSTEEL_LIGHTNING_INGOT.get())));
    ...
    public static final RegistrySupplier<Item> DREAD_QUEEN_SWORD = register("dread_queen_sword", () -> new ItemModSword(ToolMaterialUtil.of(4000, 4F, 10F, 21, 10, Items.AIR)));
    ...
    public static final RegistrySupplier<DelightFoodItem> COOKED_RICE_WITH_FIRE_DRAGON_MEAT = register("cooked_rice_with_fire_dragon_meat", () -> new DelightFoodItem(new Item.Settings().maxCount(1).food(new FoodComponent.Builder().meat().hunger(4).saturationModifier(0.6f).statusEffect(new StatusEffectInstance(StatusEffects.SATURATION, 20 * 5), 1).statusEffect(new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 20 * 60 * 2), 1).build()), Items.BOWL));
    public static final RegistrySupplier<DelightFoodItem> COOKED_RICE_WITH_ICE_DRAGON_MEAT = register("cooked_rice_with_ice_dragon_meat", () -> new DelightFoodItem(new Item.Settings().maxCount(1).food(new FoodComponent.Builder().meat().hunger(4).saturationModifier(0.6f).statusEffect(new StatusEffectInstance(StatusEffects.SATURATION, 20 * 5), 1).statusEffect(new StatusEffectInstance(StatusEffects.JUMP_BOOST, 20 * 60 * 2, 2), 1).build()), Items.BOWL));
    public static final RegistrySupplier<DelightFoodItem> COOKED_RICE_WITH_LIGHTNING_DRAGON_MEAT = register("cooked_rice_with_lightning_dragon_meat", () -> new DelightFoodItem(new Item.Settings().maxCount(1).food(new FoodComponent.Builder().meat().hunger(4).saturationModifier(0.6f).statusEffect(new StatusEffectInstance(StatusEffects.SATURATION, 20 * 5), 1).statusEffect(new StatusEffectInstance(StatusEffects.SPEED, 20 * 60 * 2, 2), 1).build()), Items.BOWL));
    public static final RegistrySupplier<DelightFoodItem> GHOST_CREAM = register("ghost_cream", () -> new DelightFoodItem(new Item.Settings().maxCount(1).food(new FoodComponent.Builder().snack().hunger(4).saturationModifier(0.6f).statusEffect(new StatusEffectInstance(StatusEffects.LEVITATION, 20 * 20), 1).build()), Items.GLASS_BOTTLE));
    public static final RegistrySupplier<DelightFoodItem> PIXIE_DUST_MILKY_TEA = register("pixie_dust_milky_tea", () -> new DelightFoodItem(new Item.Settings().maxCount(1).food(new FoodComponent.Builder().snack().hunger(4).saturationModifier(0.6f).statusEffect(new StatusEffectInstance(StatusEffects.INVISIBILITY, 20 * 60 * 2), 1).build()), Items.GLASS_BOTTLE));
