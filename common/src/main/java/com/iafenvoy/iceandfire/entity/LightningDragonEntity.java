...
public class LightningDragonEntity extends DragonBaseEntity {
    ...
    private static final TrackedData<Boolean> HAS_LIGHTNING_TARGET = DataTracker.registerData(LightningDragonEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    private static final TrackedData<Float> LIGHTNING_TARGET_X = DataTracker.registerData(LightningDragonEntity.class, TrackedDataHandlerRegistry.FLOAT);
    private static final TrackedData<Float> LIGHTNING_TARGET_Y = DataTracker.registerData(LightningDragonEntity.class, TrackedDataHandlerRegistry.FLOAT);
    private static final TrackedData<Float> LIGHTNING_TARGET_Z = DataTracker.registerData(LightningDragonEntity.class, TrackedDataHandlerRegistry.FLOAT);

    public LightningDragonEntity(EntityType<? extends LightningDragonEntity> t, World worldIn) {
    ...
    public void riderShootFire(Entity controller) {
        if (this.getRandom().nextInt(5) == 0 && !this.isBaby()) {
            if (this.getAnimation() != ANIMATION_FIRECHARGE)
                ...
                LightningDragonChargeEntity entitylargefireball = new LightningDragonChargeEntity(IafEntities.LIGHTNING_DRAGON_CHARGE.get(), this.getWorld(), this, d2, d3, d4);
