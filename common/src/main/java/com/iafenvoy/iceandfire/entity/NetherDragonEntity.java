...
public class NetherDragonEntity extends DragonBaseEntity {
    ...
    public NetherDragonEntity(EntityType<? extends NetherDragonEntity> t, World worldIn) {
        super(t, worldIn, IafDragonTypes.NETHER, 1, 1 + IafCommonConfig.INSTANCE.dragon.attackDamage.getValue(), IafCommonConfig.INSTANCE.dragon.maxHealth.getValue() * 0.04, IafCommonConfig.INSTANCE.dragon.maxHealth.getValue(), 0.15F, 0.4F);
